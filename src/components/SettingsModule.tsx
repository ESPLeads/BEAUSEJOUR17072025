    ...
    <div className="space-y-6">
      <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-400 mb-2">Conservation des archives (jours)</label>
            <select
              value={settings.system.archiveRetention}
              onChange={(e) => updateSettings('system', 'archiveRetention', parseInt(e.target.value))}
              className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white
                         focus:outline-none focus:border-cyan-500"
            >
              <option value={365}>1 an</option>
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-white">Gestion des Archives</h3>
        </div>
        
        <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-4 mb-4">
          <p className="text-gray-300 text-sm">
            Les ventes supprimées sont automatiquement archivées pour des raisons d'audit et de conformité.
            Ces archives sont conservées pendant la période définie ci-dessus, puis supprimées définitivement.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <button
            ...
            className="flex items-center justify-center space-x-2 bg-gradient-to-r from-purple-500 to-purple-600 
                       text-white font-semibold py-3 px-4 rounded-xl hover:from-purple-600 hover:to-purple-700 
                       transition-all duration-200"
          >
          ...
          <button
            onClick={() => {
              if (confirm('Êtes-vous sûr de vouloir exporter toutes les archives ? Cela peut prendre du temps.')) {
